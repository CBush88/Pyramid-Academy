...
class AttackTest {
    ...
    void attack() {
        ...
        assertTrue(String.format("%s attacks %s for %d damage.", "Player",
                goblin.getClass().getSimpleName(), goblinHp - goblinHpAfter).equals(testString1), "Bad string for human attack goblin");

        assertTrue(String.format("%s attacks %s for %d damage.", goblin.getClass().getSimpleName(),
                "Player", humanHp - humanHpAfter).equals(testString2), "Bad string for goblin attack human");
        ...
        assertTrue(String.format("%s attacks %s for %d damage. %s dies.", "Player",
